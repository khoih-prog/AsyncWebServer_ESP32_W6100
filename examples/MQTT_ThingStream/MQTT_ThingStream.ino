...
/*
  ...
  - publishes {Hello from MQTTClient_SSL on ESP32 + W6100} to the topic [ESP32_W6100_Pub]
  - subscribes to the topic [ESP32_W6100_Sub], printing out any messages
...
#define USING_THINGSTREAM_IO      false   //true
	...
	String      topic       = "ESP32_W6100_Pub";              // Topic to publish
	String      subTopic    = "ESP32_W6100_Sub";              // Topic to subcribe to
